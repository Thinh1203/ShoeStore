    ...
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-gift"></i> Sản phẩm <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="lietkesanpham.php">Danh sách sản phẩm</a></li>         
                    </ul>
                  </li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row p-2">
          <div class="col text-primary font-weight-bold text-center">ID</div>
            <div class="col text-primary font-weight-bold">Tài khoản</div>
            <div class="col text-primary font-weight-bold">Thời gian tạo</div>
            <div class="col text-primary font-weight-bold">Chức năng</div>  
          </div>
          <hr style="height:1px;border-width:0;color:gray;background-color:gray">
          <?php 
          $users = User::where('type_user','user')->orderBy('id', 'desc')->get();

          foreach($users as $user) {
            
            ?>
            <div class="row p-2">
            <div class="col text-dark font-weight-bold text-center"><?php echo $user->id ;?></div>
            <div class="col text-dark font-weight-bold"><?php echo $user->username; ?></div>
            <div class="col text-dark font-weight-bold"><?php echo $user->create_time; ?></div>

            <div class="col text-primary font-weight-bold">
              <span><a onclick="return Del('<?php echo  $user->tenSP;?>') " href="xoanguoidung.php?id=<?php echo $user->id; ?>"><i class="fa fa-trash text-danger" style="font-size: 18px;"></i></a></span> &nbsp; 
            </div>
          </div>
